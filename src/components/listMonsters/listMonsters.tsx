...
// Components
import { Card, CardBody, Heading, SimpleGrid, Flex, Divider, CardHeader, Icon, Box, Button, ButtonGroup, IconButton } from '@chakra-ui/react';
    ...
    >
      <CardHeader>
        <Flex justifyContent={'space-between'} alignItems={'center'}>
          ...
          <Heading mb={'2'} size='lg' noOfLines={1}>{monster.name}</Heading>
          <ButtonGroup isAttached variant='solid' size={'sm'}>
            <IconButton aria-label='copy monster' icon={<Icon as={PiQuestionBold} />} />
            <IconButton aria-label='copy monster' icon={<Icon as={PiCopySimpleBold} />} />
            <IconButton colorScheme={'red'} aria-label='remove monster' icon={<Icon as={PiXBold} />} />
          </ButtonGroup>
